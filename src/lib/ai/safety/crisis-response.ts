/** Ported from lumia_service_ai/app/safety_response.py */
...
LUMIA không thay thế chuyên gia y tế/tâm lý. Tìm đến một chuyên gia có thể giúp bạn ngay lúc này. Mình vẫn ở đây với bạn.`;
}
