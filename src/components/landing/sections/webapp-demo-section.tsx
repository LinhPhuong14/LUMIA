  ...
  return (
    <section id="web-app" className="relative mt-6 overflow-hidden">
      <div className="landing-frame py-16">
          ...
          {webappPages.map((p) => {
            ...
            return (
              <button
                ...
                style={{
                  background: on ? "var(--green)" : "rgba(255,255,255,0.7)",
                  color: on ? "#fff" : "var(--green-deep)",
        ...
        <div className="overflow-hidden rounded-[26px] border border-[var(--border)] bg-white shadow-[0_30px_70px_rgba(95,111,82,0.16)]">
          ...
          <div className="relative overflow-hidden bg-white" style={{ height: PREVIEW_HEIGHT }}>
            <div
