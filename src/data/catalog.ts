...
export const lumiaProducts: ProductDefinition[] = [
  ...
  {
    slug: "lumia-daily-box-3m",
    tier: "3m",
    tierLabel: "Mỗi ngày dịu hơn",
    name: "Hộp LUMIA Mỗi ngày",
    tagline: "Dành cho người muốn duy trì một nghi thức cảm xúc mỗi ngày.",
    description:
      "Chiếc hộp cho những buổi tối cần một trật tự mềm mại: ghi nhận cảm xúc, viết ra vài dòng và được gợi mở một cách tinh tế hơn.",
    price: 890000,
    durationMonths: 3,
    gradient: "linear-gradient(135deg, #FFFEFA 0%, #FFFDF5 35%, #DDE8D2 70%, #FFF3C7 100%)",
    ritualFocus: "Giữ một nhịp chăm sóc đều đặn mà không gồng ép bản thân.",
    digitalAccess: "Mở thêm nhật ký không giới hạn, lịch sử cảm xúc ngắn hạn và gợi ý phản hồi dịu hơn theo thói quen của bạn.",
    physicalItems: [
      "Nến thơm",
      "Bịt mắt ngủ",
      "Hương thơm dịu nhẹ",
    ...
    features: [
      "Không gian cá nhân đầy đủ",
      "Ghi nhận cảm xúc hằng ngày",
      "Nhật ký không giới hạn",
      "Xả cảm xúc theo gợi mở",
      "LUMIA lắng nghe 15 lượt mỗi ngày",
      "Lịch sử cảm xúc 30 ngày",
    ],
    badge: "Được chọn nhiều",
    ctaLabel: "Xem hộp mỗi ngày",
  },
  {
